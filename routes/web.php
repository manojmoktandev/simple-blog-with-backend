...
Route::middleware(['auth', 'admin'])->prefix('admin')->group(function () {
    ...
    Route::get('add-category', [CategoryController::class, 'addCategory'])->name('categories.add');
    Route::get('edit-category/{id}', [CategoryController::class, 'editCategory'])->name("category.edit");
    Route::post('store-category', [CategoryController::class, 'storeCategory'])->name('categories.store');

    # Blog routes
    Route::get('blogs', [BlogController::class, 'blogs'])->name('blogs');
    Route::get('add-blog', [BlogController::class, 'addBlog'])->name('blogs.add');
    Route::get('edit-blog/{id}', [BlogController::class, 'editBlog'])->name("blogs.edit");
    Route::post('store-blog', [BlogController::class, 'storeBlog'])->name('blogs.store');
	...
	# Blog Comments
	Route::get('blog-comments',[BlogCommentController::class,'blogsComment'])->name('blog.comments');
});
